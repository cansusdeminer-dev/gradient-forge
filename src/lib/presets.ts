...
export const PRESETS: Preset[] = [
...

  {
    ...
    name: '🏜️ Desert Dunes',
    category: '2d',
    description: 'Windswept sand dunes with warm copper coloring',
    nodes: [
      makeNode('p-1', 'ridged', 50, 100, { frequency: 2, octaves: 6, lacunarity: 2.5, persistence: 0.45, seed: 88 }),
      makeNode('p-2', 'domainWarp', 300, 100, { strength: 0.2, frequency: 3, seed: 15 }),
      makeNode('p-3', 'colorMap', 520, 100, { palette: 14, contrast: 1.2 }),
      makeNode('p-4', 'vignette', 520, 300, { strength: 0.4, radius: 0.85 }),
      makeNode('p-5', 'output', 740, 180),
    ],
    edges: [
      makeEdge('pe-1', 'p-1', 'p-2'),
      makeEdge('pe-2', 'p-2', 'p-3'),
...

  {
    ...
    name: '🦠 Neon Bacteria',
    category: '2d',
    description: 'Reaction-diffusion with neon cyberpunk coloring',
    nodes: [
      makeNode('p-1', 'reactionDiffusion', 50, 180, { feed: 0.037, kill: 0.06, iterations: 3000 }),
      makeNode('p-2', 'colorMap', 340, 180, { palette: 9, contrast: 2 }),
      makeNode('p-3', 'bloom', 560, 180, { threshold: 0.3, intensity: 0.6, radius: 4 }),
      makeNode('p-4', 'chromaticSplit', 560, 350, { offset: 3, angle: 30 }),
      makeNode('p-5', 'output', 780, 250),
    ],
    edges: [
      makeEdge('pe-1', 'p-1', 'p-2'),
      makeEdge('pe-2', 'p-2', 'p-3'),
...

  {
    ...
    name: '🔩 Rusted Metal',
    category: '2d',
    description: 'Weathered metallic surface with corrosion',
    nodes: [
      makeNode('p-1', 'perlin', 50, 80, { frequency: 6, octaves: 5, persistence: 0.55, seed: 64 }),
      makeNode('p-2', 'voronoi', 50, 300, { scale: 10, jitter: 0.9, mode: 2, seed: 17 }),
      makeNode('p-3', 'blend', 300, 180, { mode: 1, opacity: 0.6 }),
      makeNode('p-4', 'colorMap', 520, 180, { palette: 8, contrast: 1.4 }),
      makeNode('p-5', 'filmGrain', 740, 180, { intensity: 0.1, seed: 9 }),
      makeNode('p-6', 'output', 960, 180),
    ],
    edges: [
      makeEdge('pe-1', 'p-1', 'p-3', 'out', 'a'),
  ...
  {
    id: 'topographic',
    name: '🗺️ Topographic Map',
    category: '2d',
    description: 'Contour lines over terrain noise — map aesthetic',
    nodes: [
      makeNode('p-1', 'perlin', 50, 180, { frequency: 3, octaves: 6, persistence: 0.5, seed: 200 }),
      makeNode('p-2', 'posterize', 300, 100, { levels: 20 }),
      makeNode('p-3', 'edgeDetect', 520, 100),
      makeNode('p-4', 'colorMap', 300, 300, { palette: 18, contrast: 0.7 }),
      makeNode('p-5', 'blend', 740, 200, { mode: 2, opacity: 0.8 }),
      makeNode('p-6', 'output', 960, 200),
    ],
    edges: [
      makeEdge('pe-1', 'p-1', 'p-2'),
      makeEdge('pe-2', 'p-2', 'p-3'),
      makeEdge('pe-3', 'p-1', 'p-4'),
      makeEdge('pe-4', 'p-4', 'p-5', 'out', 'a'),
      makeEdge('pe-5', 'p-3', 'p-5', 'out', 'b'),
      makeEdge('pe-6', 'p-5', 'p-6'),
    ],
  },

  {
    ...
    category: '2d',
    description: 'High-energy plasma discharge with violet palette',
    nodes: [
      makeNode('p-1', 'turbulence', 50, 100, { frequency: 5, octaves: 8, persistence: 0.6, seed: 44 }),
      makeNode('p-2', 'lightning', 50, 350, { branches: 6, detail: 10, glow: 3, seed: 77 }),
      makeNode('p-3', 'blend', 300, 200, { mode: 2, opacity: 0.5 }),
      makeNode('p-4', 'colorMap', 520, 200, { palette: 17, contrast: 1.8 }),
      makeNode('p-5', 'bloom', 740, 200, { threshold: 0.25, intensity: 0.8, radius: 10 }),
      makeNode('p-6', 'output', 960, 200),
    ],
    edges: [
      makeEdge('pe-1', 'p-1', 'p-3', 'out', 'a'),
...

  {
    ...
    name: '🐉 Dragon Scales',
    category: '2d',
    description: 'Hexagonal scale pattern with metallic sheen',
    nodes: [
      makeNode('p-1', 'hexGrid', 50, 100, { scale: 15, lineWidth: 0.04 }),
      makeNode('p-2', 'perlin', 50, 350, { frequency: 8, octaves: 3, persistence: 0.4, seed: 55 }),
      makeNode('p-3', 'blend', 300, 200, { mode: 1, opacity: 0.4 }),
      makeNode('p-4', 'colorMap', 520, 200, { palette: 6, contrast: 1.5 }),
      makeNode('p-5', 'normalMap', 740, 200, { strength: 4 }),
      makeNode('p-6', 'output', 960, 200),
    ],
    edges: [
      makeEdge('pe-1', 'p-1', 'p-3', 'out', 'a'),
...

  {
    ...
    category: '2d',
    description: 'Soft diffused colors like watercolor paint',
    nodes: [
      makeNode('p-1', 'simplex', 50, 100, { frequency: 2, octaves: 3, persistence: 0.3, seed: 123 }),
      makeNode('p-2', 'simplex', 50, 350, { frequency: 3, octaves: 4, persistence: 0.4, seed: 456 }),
      makeNode('p-3', 'blend', 300, 200, { mode: 0, opacity: 0.5 }),
      makeNode('p-4', 'domainWarp', 520, 200, { strength: 0.12, frequency: 2, seed: 8 }),
      makeNode('p-5', 'colorMap', 740, 200, { palette: 4, contrast: 0.6 }),
      makeNode('p-6', 'output', 960, 200),
    ],
    edges: [
      makeEdge('pe-1', 'p-1', 'p-3', 'out', 'a'),
...

  {
    ...
    name: '🔌 Circuit Board',
    category: '2d',
    description: 'PCB-style traces with grid and edge detection',
    nodes: [
      makeNode('p-1', 'checker', 50, 100, { scale: 16 }),
      makeNode('p-2', 'voronoi', 50, 350, { scale: 8, jitter: 0.5, mode: 3, seed: 42 }),
      makeNode('p-3', 'blend', 300, 200, { mode: 1, opacity: 0.7 }),
      makeNode('p-4', 'edgeDetect', 520, 200),
      makeNode('p-5', 'colorMap', 740, 200, { palette: 18, contrast: 1.8 }),
      makeNode('p-6', 'scanlines', 740, 380, { spacing: 2, intensity: 0.1 }),
      makeNode('p-7', 'output', 960, 200),
    ],
    edges: [
      makeEdge('pe-1', 'p-1', 'p-3', 'out', 'a'),
...

  {
    ...
    name: '🌑 Moonscape',
    category: '2d',
    description: 'Cratered lunar surface with grayscale palette',
    nodes: [
      makeNode('p-1', 'voronoi', 50, 100, { scale: 5, jitter: 1, mode: 0, seed: 33 }),
      makeNode('p-2', 'perlin', 50, 350, { frequency: 8, octaves: 4, persistence: 0.4, seed: 99 }),
      makeNode('p-3', 'blend', 300, 200, { mode: 1, opacity: 0.3 }),
      makeNode('p-4', 'levels', 520, 200, { brightness: -0.1, contrast: 1.5, gamma: 0.8 }),
      makeNode('p-5', 'colorMap', 740, 200, { palette: 13, contrast: 1 }),
      makeNode('p-6', 'output', 960, 200),
    ],
    edges: [
      makeEdge('pe-1', 'p-1', 'p-3', 'out', 'a'),
  ...
  {
    id: 'rain-on-glass',
    name: '🌧️ Rain on Glass',
    category: '2d',
    description: 'Raindrop ripples on a fogged glass surface',
    nodes: [
      makeNode('p-1', 'rippleWaves', 50, 100, { frequency: 30, decay: 5, cx: 0.5, cy: 0.5, sources: 8, seed: 77 }),
      makeNode('p-2', 'simplex', 50, 350, { frequency: 10, octaves: 3, persistence: 0.3, seed: 44 }),
      makeNode('p-3', 'blend', 300, 200, { mode: 2, opacity: 0.15 }),
      makeNode('p-4', 'colorMap', 520, 200, { palette: 7, contrast: 0.6 }),
      makeNode('p-5', 'output', 740, 200),
    ],
    edges: [
      makeEdge('pe-1', 'p-1', 'p-3', 'out', 'a'),
  ...
  {
    id: '3d-diamond-lattice',
    name: '💎 Diamond Lattice',
    category: '3d',
    description: 'Gyroid + Schwarz P intersection — complex lattice',
    nodes: [
      makeNode('p-1', 'sdfGyroid', 50, 100, { scale: 5, thickness: 0.15 }),
      makeNode('p-2', 'sdfSchwarzP', 50, 350, { scale: 5, thickness: 0.15 }),
      makeNode('p-3', 'sdfSmoothUnion', 300, 200, { smoothness: 0.1 }),
      makeNode('p-4', 'sdfSphere', 300, 420, { radius: 1.2 }),
      makeNode('p-5', 'sdfIntersect', 520, 300),
      makeNode('p-6', 'extractMesh', 740, 150, { resolution: 48 }),
      makeNode('p-7', 'glassMaterial', 740, 400, { r: 255, g: 240, b: 200, roughness: 0.05 }),
      makeNode('p-8', 'output3D', 960, 280),
    ],
    edges: [
      makeEdge('pe-1', 'p-1', 'p-3', 'out', 'a'),
      makeEdge('pe-2', 'p-2', 'p-3', 'out', 'b'),
      makeEdge('pe-3', 'p-3', 'p-5', 'out', 'a'),
      makeEdge('pe-4', 'p-4', 'p-5', 'out', 'b'),
      makeEdge('pe-5', 'p-5', 'p-6', 'out', 'sdf'),
      makeEdge('pe-6', 'p-6', 'p-8', 'out', 'mesh'),
      makeEdge('pe-7', 'p-7', 'p-8', 'out', 'material'),
...

  {
    ...
    name: '🍄 Mushroom',
    category: '3d',
    description: 'Organic mushroom shape from smooth union of capsule + sphere',
    nodes: [
      makeNode('p-1', 'sdfCapsule', 50, 100, { height: 0.6, radius: 0.15 }),
      makeNode('p-2', 'sdfSphere', 50, 300, { radius: 0.5, cx: 0, cy: 0.5, cz: 0 }),
      makeNode('p-3', 'sdfSmoothUnion', 300, 180, { smoothness: 0.2 }),
      makeNode('p-4', 'sdfDisplace', 520, 180, { strength: 0.04, frequency: 12 }),
      makeNode('p-5', 'extractMesh', 740, 80, { resolution: 40 }),
      makeNode('p-6', 'pbrMaterial', 740, 320, { r: 200, g: 60, b: 60, roughness: 0.7, metalness: 0 }),
      makeNode('p-7', 'output3D', 960, 180),
    ],
    edges: [
      makeEdge('pe-1', 'p-1', 'p-3', 'out', 'a'),
      makeEdge('pe-2', 'p-2', 'p-3', 'out', 'b'),
...

  {
    ...
    name: '🛸 Space Station',
    category: '3d',
    description: 'Torus + cylinders — orbital station structure',
    nodes: [
      makeNode('p-1', 'sdfTorus', 50, 100, { major: 0.8, minor: 0.12 }),
      makeNode('p-2', 'sdfCylinder', 50, 300, { radius: 0.08, height: 1.6 }),
      makeNode('p-3', 'sdfCylinder', 50, 500, { radius: 0.08, height: 1.6 }),
      makeNode('p-4', 'sdfRotate', 280, 500, { rx: 0, ry: 0, rz: 90 }),
      makeNode('p-5', 'sdfSmoothUnion', 300, 180, { smoothness: 0.05 }),
      makeNode('p-6', 'sdfSmoothUnion', 520, 320, { smoothness: 0.05 }),
      makeNode('p-7', 'extractMesh', 740, 200, { resolution: 44 }),
      makeNode('p-8', 'metalMaterial', 740, 450, { r: 180, g: 190, b: 200, roughness: 0.15 }),
      makeNode('p-9', 'output3D', 960, 300),
    ],
    edges: [
      makeEdge('pe-1', 'p-1', 'p-5', 'out', 'a'),
      makeEdge('pe-2', 'p-2', 'p-5', 'out', 'b'),
      makeEdge('pe-3', 'p-5', 'p-6', 'out', 'a'),
      makeEdge('pe-4', 'p-3', 'p-4'),
      makeEdge('pe-5', 'p-4', 'p-6', 'out', 'b'),
      makeEdge('pe-6', 'p-6', 'p-7', 'out', 'sdf'),
      makeEdge('pe-7', 'p-7', 'p-9', 'out', 'mesh'),
      makeEdge('pe-8', 'p-8', 'p-9', 'out', 'material'),
    ],
...

  {
    ...
    name: '💀 Abstract Skull',
    category: '3d',
    description: 'Sphere with eye-socket subtractions — stylized skull',
    nodes: [
      makeNode('p-1', 'sdfSphere', 50, 100, { radius: 0.7 }),
      makeNode('p-2', 'sdfSphere', 50, 300, { radius: 0.2, cx: -0.25, cy: 0.1, cz: 0.55 }),
      makeNode('p-3', 'sdfSphere', 50, 500, { radius: 0.2, cx: 0.25, cy: 0.1, cz: 0.55 }),
      makeNode('p-4', 'sdfSmoothSubtract', 300, 180, { smoothness: 0.08 }),
      makeNode('p-5', 'sdfSmoothSubtract', 300, 380, { smoothness: 0.08 }),
      makeNode('p-6', 'sdfBox', 520, 480, { width: 0.2, height: 0.3, depth: 0.3, round: 0.02 }),
      makeNode('p-7', 'sdfTranslate', 520, 350, { tx: 0, ty: -0.25, tz: 0.4 }),
      makeNode('p-8', 'sdfSmoothSubtract', 740, 280, { smoothness: 0.05 }),
      makeNode('p-9', 'extractMesh', 960, 180, { resolution: 44 }),
      makeNode('p-10', 'pbrMaterial', 960, 420, { r: 230, g: 220, b: 200, roughness: 0.6, metalness: 0 }),
      makeNode('p-11', 'output3D', 1180, 280),
    ],
    edges: [
      makeEdge('pe-1', 'p-1', 'p-4', 'out', 'a'),
      makeEdge('pe-2', 'p-2', 'p-4', 'out', 'b'),
      makeEdge('pe-3', 'p-4', 'p-5', 'out', 'a'),
      makeEdge('pe-4', 'p-3', 'p-5', 'out', 'b'),
      makeEdge('pe-5', 'p-6', 'p-7'),
      makeEdge('pe-6', 'p-5', 'p-8', 'out', 'a'),
      makeEdge('pe-7', 'p-7', 'p-8', 'out', 'b'),
      makeEdge('pe-8', 'p-8', 'p-9', 'out', 'sdf'),
      makeEdge('pe-9', 'p-9', 'p-11', 'out', 'mesh'),
      makeEdge('pe-10', 'p-10', 'p-11', 'out', 'material'),
    ],
  },

  {
    id: '3d-twisted-column',
    name: '🏛️ Twisted Column',
    category: '3d',
    description: 'Classical column with dramatic twist deformation',
    nodes: [
      makeNode('p-1', 'sdfCylinder', 50, 200, { radius: 0.35, height: 1.2 }),
      makeNode('p-2', 'sdfTwist', 280, 200, { twist: 5 }),
      makeNode('p-3', 'sdfDisplace', 500, 200, { strength: 0.03, frequency: 15 }),
      makeNode('p-4', 'extractMesh', 720, 100, { resolution: 48 }),
      makeNode('p-5', 'metalMaterial', 720, 350, { r: 220, g: 200, b: 170, roughness: 0.3 }),
      makeNode('p-6', 'output3D', 940, 200),
    ],
    edges: [
      makeEdge('pe-1', 'p-1', 'p-2'),
...

  {
    ...
    name: '☄️ Asteroid',
    category: '3d',
    description: 'Irregular rocky body with craters and rough surface',
    nodes: [
      makeNode('p-1', 'sdfSphere', 50, 200, { radius: 0.7 }),
      makeNode('p-2', 'sdfDisplace', 280, 200, { strength: 0.3, frequency: 3 }),
      makeNode('p-3', 'sdfDisplace', 500, 200, { strength: 0.1, frequency: 10 }),
      makeNode('p-4', 'sdfScale', 720, 200, { scale: 0.9 }),
      makeNode('p-5', 'extractMesh', 940, 100, { resolution: 44 }),
      makeNode('p-6', 'pbrMaterial', 940, 350, { r: 100, g: 90, b: 80, roughness: 0.95, metalness: 0.1 }),
      makeNode('p-7', 'output3D', 1160, 200),
    ],
    edges: [
      makeEdge('pe-1', 'p-1', 'p-2'),
  ...
  {
    id: '3d-alien-artifact',
    name: '🛸 Alien Artifact',
    category: '3d',
    description: 'Pyramid with gyroid carving — mysterious relic',
    nodes: [
      makeNode('p-1', 'sdfPyramid', 50, 100, { height: 1.2, base: 1 }),
      makeNode('p-2', 'sdfGyroid', 50, 350, { scale: 8, thickness: 0.1 }),
      makeNode('p-3', 'sdfSmoothSubtract', 300, 200, { smoothness: 0.05 }),
      makeNode('p-4', 'sdfRotate', 520, 200, { rx: 0, ry: 30, rz: 0 }),
      makeNode('p-5', 'extractMesh', 740, 100, { resolution: 48 }),
      makeNode('p-6', 'emissiveMaterial', 740, 350, { r: 50, g: 255, b: 150, intensity: 1 }),
      makeNode('p-7', 'output3D', 960, 200),
    ],
    edges: [
      makeEdge('pe-1', 'p-1', 'p-3', 'out', 'a'),
...

  {
    ...
    name: '🪐 Ringed Planet',
    category: '3d',
    description: 'Sphere with a flat torus ring — planetary body',
    nodes: [
      makeNode('p-1', 'sdfSphere', 50, 100, { radius: 0.5 }),
      makeNode('p-2', 'sdfTorus', 50, 350, { major: 0.9, minor: 0.03 }),
      makeNode('p-3', 'sdfSmoothUnion', 300, 200, { smoothness: 0.02 }),
      makeNode('p-4', 'sdfDisplace', 520, 200, { strength: 0.02, frequency: 8 }),
      makeNode('p-5', 'extractMesh', 740, 100, { resolution: 44 }),
      makeNode('p-6', 'pbrMaterial', 740, 350, { r: 180, g: 140, b: 100, roughness: 0.5, metalness: 0.1 }),
      makeNode('p-7', 'output3D', 960, 200),
    ],
    edges: [
      makeEdge('pe-1', 'p-1', 'p-3', 'out', 'a'),
